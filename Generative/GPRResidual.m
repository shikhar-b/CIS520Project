...
%     end
    ...
    predicted_train_residuals = RandomForest(train_inputs_pre_g, residual_err, train_inputs_pre_g);
    test_labels = test_labels + predicted_residuals;
    predicted_train_labels = predicted_train_labels + predicted_train_residuals;
    residual_err = train_labels - predicted_train_labels;
    predicted_residuals = ridgeRegression(train_inputs_pre_g, residual_err, test_inputs_pre_g);
    test_labels = test_labels + predicted_residuals;