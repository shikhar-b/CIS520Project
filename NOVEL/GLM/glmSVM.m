function test_labels = glmSVM(train_inputs, train_labels, test_inputs)
    ...
    predicted_residuals = SupportVectorMachines(train_inputs_pre_g, residual_err, test_inputs_pre_g);
